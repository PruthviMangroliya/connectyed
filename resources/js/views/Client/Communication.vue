...
<template>
  <div class="container mx-auto p-4">
    <!-- Rest of your communication component code -->
...
export default {
  ...
  data() {
    return {
      ...
      googleTagLoaded: false, // To prevent multiple script loads
    };
  },
  computed: {
    ...mapState({
  ...
  mounted() {
    ...
    // Load Google Tag when the component is mounted
    this.loadGoogleTag();
  },
  methods: {
    /**
     ...
     */
    loadGoogleTag() {
      if (this.googleTagLoaded) return; // Prevent loading multiple times

      // Load the Google Tag script
      const script1 = document.createElement('script');
      script1.async = true;
      script1.src = 'https://www.googletagmanager.com/gtag/js?id=AW-16739328770';
